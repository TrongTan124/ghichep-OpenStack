...
<ul> <b>5 đặc tính</b>
<li> Rapid elasticity: (<i>Capabilities can be elastically provisioned and released, in some cases
automatically, to scale rapidly outward and inward commensurate with demand. To the
consumer, the capabilities available for provisioning often appear to be unlimited and can
be appropriated in any quantity at any time</i>)</li>
<li> Broad network access: (<i>Capabilities are available over the network and accessed through standard
mechanisms that promote use by heterogeneous thin or thick client platforms (e.g.,
mobile phones, tablets, laptops, and workstations)</i>)</li>
<li> Resource pooling: (<i>The provider’s computing resources are pooled to serve multiple consumers
...
<li> Measured service: (<i>Cloud systems automatically control and optimize resource use by leveraging
...
<li> On-demand self-service: (<i>A consumer can unilaterally provision computing capabilities, such as
